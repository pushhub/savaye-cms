...
module.exports = {
  ...
  fetchAll: (params, populate) => {
    ...
    const populateOpt = populate || Resource.associations
  ...
  add: async (values) => {
    ...
    return Resource.updateRelations({ _id: entry.id, values: relations });
  },
  ...
  edit: async (params, values) => {
    ...
    const entry = await Resource.updateOne(params, data, { multi: true });
